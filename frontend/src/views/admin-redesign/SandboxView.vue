...
.sbx__bar-meta { font-size: var(--mk-fs-12); color: var(--mk-faint, #71809a); }
.sbx__bar-btn {
  margin-left: auto;
  padding: 4px 12px;
...
.sbx__groupcount { font-size: var(--mk-fs-12); color: var(--mk-faint, #71809a); }
...
.sbx__agentdesc { color: var(--mk-faint, #71809a); font-size: var(--mk-fs-12); }
...
.sbx__label { margin: 2px 0 8px; font-size: var(--mk-fs-11); font-weight: 700; letter-spacing: 0.05em; color: var(--mk-faint, #71809a); text-transform: uppercase; }
