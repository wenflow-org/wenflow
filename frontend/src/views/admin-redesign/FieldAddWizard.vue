...
.faw__warn { margin: 0; padding: 6px 10px; border: 1px dashed rgba(180, 83, 9, 0.45); border-radius: 8px; background: var(--mk-amber-bg, #fffbeb); color: var(--mk-amber, #b45309); font-size: var(--mk-fs-micro); font-weight: 600; }
...
.faw__msg { margin: 0; padding: 9px 12px; border: 1px solid rgba(44, 99, 208, 0.35); border-radius: 9px; background: #f0f5ff; color: var(--mk-blue, #2c63d0); font-size: var(--mk-fs-micro); font-weight: 600; line-height: 1.5; white-space: pre-wrap; }
...
.faw__result-list { margin: 8px 0 0; padding: 0 0 0 18px; display: grid; gap: 4px; font-size: var(--mk-fs-micro); color: var(--mk-muted, #5b6577); }
.faw__result-hint { color: var(--mk-faint, var(--mk-faint-soft)); font-size: var(--mk-fs-micro); }
.faw__result-note { margin: 10px 0 0; font-size: var(--mk-fs-micro); font-weight: 600; color: var(--mk-ink, #1a2a44); line-height: 1.55; }
...
@media (min-width: 2000px) {
  .faw__preview-code { font-size: var(--mk-fs-micro); }
  .faw__result-list { font-size: var(--mk-fs-body); }
  .faw__result-title { font-size: var(--mk-fs-body); }
  .faw__result-note { font-size: var(--mk-fs-micro); }
}
...
@media (min-width: 3600px) {
  .faw__preview-code { font-size: var(--mk-fs-body); }
  .faw__result-list { font-size: var(--mk-fs-emphasis); }
  .faw__result-title { font-size: var(--mk-fs-emphasis); }
