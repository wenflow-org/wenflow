...
7. **session-evaluation-fallback / goal-alignment-checker 等 aux skill**（session-wrapup/index.ts:630-631 调用；session-evaluation-fallback 已于 2026-08-11 退役，goal-alignment-checker 为注册中零调用僵尸项）不在任何 orchestration contracts 中。
