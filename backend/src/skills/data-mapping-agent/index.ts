/**
 * [ARCH NOTE] NOT a real agent. This is a utility class (AI-assisted JSON field
 * mapping tool). It has no AgentDefinition, is not in allAgentDefinitions, and is
 * not driven by the orchestrator/gateway. It is called as a plain helper
 * (mapPersona) from arena.service. It has NO prompts/skill.*.md file and is OUT OF
 * SCOPE for the Prompt Authoring Protocol (its prompt is inlined in getSystemPrompt).
 * TODO(arch): rename away from "Agent" or move under utils/.
 */
/**
