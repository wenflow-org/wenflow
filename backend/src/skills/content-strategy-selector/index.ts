/**
 * [ARCH NOTE] NOT a real agent. This is a pure rule-based function library
 * (hardcoded STRATEGY_CONFIGS lookup + if/else cognitive-load inference). No LLM,
 * no AgentDefinition, no handler. Called via selectContentStrategy(). It has NO
 * prompts/skill.*.md file and is OUT OF SCOPE for the Prompt Authoring Protocol.
 * TODO(arch): rename away from "agent" dir or move under utils/.
 */
/**
