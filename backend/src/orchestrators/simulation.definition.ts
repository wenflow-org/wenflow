export const simulationOrchestratorRuntimeDefinition = {
  ...
  steps: [
    { step: 1, agentId: 'virtual-learner-simulation-agent', role: 'virtual-learner-opening-and-turn-simulation', loopOver: 'goal-rounds' },
    ...
    { step: 4, agentId: 'virtual-learner-simulation-agent', role: 'path-review-reaction', condition: 'when a learning path is available' },
    { step: 5, agentId: 'orchestrator:ai-teaching', role: 'learning-session-execution', condition: 'when learning phase starts', loopOver: 'learning-turns' },
  ],
  variableGraph: {
