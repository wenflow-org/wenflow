export const AITeachingCoordinatorRuntimeDefinition = {
  ...
  steps: [
    ...
    { step: 2, agentId: 'skill:learning-turn', role: 'learning-turn-generation', loopOver: 'messages' },
  ...
  variableGraph: {
    ...
    learningTurn: ['reply', 'analysis', 'knowledge.points', 'pedagogy.strategies', 'control'],
