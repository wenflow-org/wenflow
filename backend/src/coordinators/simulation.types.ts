...
export interface SimulationLogEntry {
  timestamp: string;
  phase: 'virtual-reply' | 'goal-response' | 'stage-transition' | 'path-review' | 'path-replan' | 'path-replan-guard' | 'path-regenerate' | 'path-enrichment-not-ready' | 'teaching-reply' | 'teaching-response' | 'teaching-start' | 'error';
  durationMs?: number;
  details: {
    input?: any;
    output?: any;
